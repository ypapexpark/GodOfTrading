...
# 2026-07-03 1차 수정: 1.50 → 1.00 (SHIB1000 사례 재발 방지).
# 2026-07-03 2차 수정: 1.00 → 1.25. 1.00은 일손실한도 소진 시점과 겹쳐서
# TP1 R:R이 진짜 좋은 화이트리스트 신호까지 전부 막아버렸다 (같은 날 XPL/ZEC/
# TRUMP/ETH/ARPA/SOL/TIA VERY STRONG 신호 전량 차단 확인). 위에서 TP1 R:R
# 하한을 별도로 추가했으니, 낮은 R:R 자리를 막는 역할은 그쪽에 맡기고
# 여기는 "진짜 좋은 자리는 손실 중에도 축소진입으로 회복 기회를 준다"는
# 원래 취지를 회복한다.
HIGH_OPPORTUNITY_DAILY_LOSS_DISABLE_AT = 1.25
